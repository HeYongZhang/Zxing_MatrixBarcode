...
public class MatrixCreate {
    ...
    public BitMatrix createMatrix() throws WriterException {
       return new MultiFormatWriter().encode(matrixProperties.getContext(), BarcodeFormat.QR_CODE,matrixProperties.getWidth(),matrixProperties.getHeight(),matrixProperties.getHints());
    }
